...
def cross_product(*arrays: list[Any]) -> Generator[list[...]]:
    ...
    return _cross_product(empty_result, 0, *arrays)


def _cross_product(current_result: list[...], array_index: int, *arrays: list[Any]) -> Generator[list[...]]:
    ...
    for value in arrays[array_index]:
        ...
        yield from _cross_product(current_result, array_index + 1, *arrays)
